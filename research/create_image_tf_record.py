...
def main(_):
  ...
  data_dir =FLAGS.data_dir #'/home/leikun/temp/AI100-W9' # FLAGS.data_dir

  # label_items.txt文件路径/home/leikun/temp/AI100-W9/labels_items.txt
  # label_path = '/home/leikun/temp/AI100-W9/labels_items.txt'
  label_map_dict = label_map_util.get_label_map_dict(FLAGS.label_map_path) #(label_path) # (FLAGS.label_map_path)
  ...
  train_output_path = os.path.join(FLAGS.output_dir, 'pet_train.record') #(output_dir, 'pet_train.record') # (FLAGS.output_dir, 'pet_train.record')
  val_output_path = os.path.join(FLAGS.output_dir, 'pet_val.record') #(output_dir, 'pet_val.record') # (FLAGS.output_dir, 'pet_val.record')
